...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public DataSource credentialSource(){
		...
		try {
			...
			System.out.println("-----------++++++++++++++++++++++++++++++------------------------");
			System.out.println("-----------++++++++++++++++++++++++++++++------------------------");
			System.out.println("DERBY_DRIVER");
			System.out.println(environment.getProperty("DERBY_DRIVER"));
			System.out.println("-----------++++++++++++++++++++++++++++++------------------------");
			dataSource.setDriverClass(environment.getProperty("DERBY_DRIVER"));
		} catch (PropertyVetoException e) {
			e.printStackTrace();
		}
		String jdbURL = environment.getProperty("DATABASE_LINK") +"/" +environment.getProperty("DATABASE_CREDENTIAL");
